...
protected:
    void SetUp() override {
        ...
        threadPool = std::make_unique<ThreadPool::ThreadPool<ThreadPool::ThreadMode::STANDARD, ThreadPool::AdoptiveControl::ENABLED>>(10); // Assume 4 as default thread count
    }
