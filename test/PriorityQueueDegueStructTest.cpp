...
class PriorityQueueDequeTest : public ::testing::Test {
protected:
    ThreadPool::PriorityQueue<CustomStruct, std::deque<CustomStruct>> priorityQueue;
};

TEST_F(PriorityQueueDequeTest, CustomStructOrdering) {
...
class CustomStructPriorityQueueDegueTest : public ::testing::Test {
protected:
    ThreadPool::PriorityQueue<CustomTask, std::deque<CustomTask>> priorityQueue;
};

TEST_F(CustomStructPriorityQueueDegueTest, RemoveFunctionality) {
...
TEST_F(PriorityQueueDequeTest, StressTestCustomStruct) {
...
TEST_F(CustomStructPriorityQueueDegueTest, StressTestCustomTask) {
    constexpr int itemCount = 1000000;  // a large number of items
