...
protected:
    ThreadPool::PriorityQueue<int, std::deque<int>> priorityQueue;
};

TEST_F(PriorityQueueDequeTest, ConstructEmpty) {
    EXPECT_TRUE(priorityQueue.empty());
    EXPECT_EQ(priorityQueue.size(), 0);
}

TEST_F(PriorityQueueDequeTest, PushPopElement) {
...
TEST_F(PriorityQueueDequeTest, OrderElementsCorrectly) {
...
TEST_F(PriorityQueueDequeTest, EmplaceElement) {
...
TEST_F(PriorityQueueDequeTest, RemoveElement) {
    priorityQueue.push(1);
    priorityQueue.push(2);
...
TEST_F(PriorityQueueDequeTest, TopElement) {
    priorityQueue.push(3);
    priorityQueue.push(1);
...
TEST_F(PriorityQueueDequeTest, StressTest) {
