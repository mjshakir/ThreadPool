...
protected:
    void SetUp() override {
        ...
        threadPool = std::make_unique<ThreadPool::ThreadPool<ThreadPool::ThreadMode::PRIORITY, 0UL>>(10); // Assume 4 as default thread count
    }
    ...
    std::unique_ptr<ThreadPool::ThreadPool<ThreadPool::ThreadMode::PRIORITY, 0UL>> threadPool;
};
